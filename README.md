...
- Quick Overview modal for all bars and a specific bartender
- Google Sheets reporting bridge settings
- Complimentary and Shot Ticket actions on submit form
- Reports page sends to Google Sheet instead of file exports
